...
function Menubtns({ iconClass, label, onClick, isSelected }) {
    return (
        <div className={` shadow-md flex justify-center items-center rounded-xl h-full p-4 w-full ${isSelected ? 'bg-active' : 'bg-secondary'} transition-all duration-300 ease-in-out`}>
